export default function NewTask({title, date, description, category}) {
    return(
        <div className="flex-shrink-0 h-full w-[360px] bg-blue-400 rounded-xl p-4 text-white">
                ...
                <div className="mt-16">
                    <button className="bg-green-500 py-1 px-2 rounded-sm cursor-pointer hover:bg-green-600 w-full">Accept Task</button>
                </div>
        </div>
    )
}